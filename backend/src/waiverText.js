...
export const WAIVER_PARAGRAPHS = [
  ...
  "Recording of training: Gravitas Mixed Martial Arts records classes, sparring, and other training sessions on the premises, and makes clips of those sessions available to the participants who trained in them. By signing this waiver you consent to being recorded while training, and to those recordings being used for coaching and instructional review, for reviewing injuries or other incidents, and for being shared with the other participants who appear in the same session. Recordings will not be used for advertising, marketing, or any other public promotion without your separate written permission. If you do not wish to be recorded, tell a coach before class and Gravitas Mixed Martial Arts will make reasonable accommodations.",
